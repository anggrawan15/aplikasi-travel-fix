    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
            ...
            @endif
            <li class="active"><a href="{{url('wisata')}}">Wisata</a></li>
    ...
    <section id="more-services" class="more-services">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Destinasi Wisata</h2>
          <p>Nikmati Berwisata Ditempat Terpopuler DiPulau Lombok.</p>
        </div>

        <div class="row">
          @forelse($wisatas as $row)
          <div class="col-md-6 d-flex align-items-stretch mt-4">
            <div class="card" style='background-image: url("{{ asset('storage/wisatas/'. $row->gambar) }}");' data-aos="fade-up" data-aos-delay="100">
              <div class="card-body">
                <h5 class="card-title"><a href="{{route('wisata.detail', $row->id) }}">{{$row->nama}}</a></h5>
                <p class="card-text">{{$row->deskripsi}}</p>
                <div class="read-more">
                  <a href="{{route('wisata.detail', $row->id) }}"><i class="icofont-arrow-right"></i> Lihat Selengkapnya..</a>
                </div>
              </div>
            </div>
          </div>
