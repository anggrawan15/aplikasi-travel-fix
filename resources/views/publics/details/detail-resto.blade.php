    ...
    <section id="portfolio-details" class="portfolio-details">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                <h2 class="portfolio-title">This is Information Hotel</h2>
                <div class="owl-carousel portfolio-details-carousel">
                    <img src="{{asset('storage/restos/'. $restod->gambar) }}" class="img-fluid" alt="">
                ...
                <ul>
                    <li><strong>Nama : </strong> {{ $restod->nama }}</li>
                    <li><strong>Lokasi : </strong> {{ $restod->lokasi }}</li>
