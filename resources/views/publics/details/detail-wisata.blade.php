    ...
    <section id="portfolio-details" class="portfolio-details">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                <h2 class="portfolio-title">This is Information Wisata</h2>
                <div class="owl-carousel portfolio-details-carousel">
                    <img src="{{ asset('storage/wisatas/'. $wisatad->gambar) }}" class="img-fluid" alt="">

                </div>
                </div>
    
                <div class="col-lg-4 portfolio-info">
                <h3>Wisata Information</h3>
                <ul>
                    <li><strong>Nama : </strong> {{ $wisatad->nama }}</li>
                    <li><strong>Lokasi : </strong> {{ $wisatad->lokasi }}</li>
