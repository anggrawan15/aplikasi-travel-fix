    ...
    <div class="row">
      ...
      <div class="col-md-6 d-flex align-items-stretch mt-4">
        <div class="card" style='background-image: url("{{ asset('storage/pakets/'. $row->gambar) }}");' data-aos="fade-up" data-aos-delay="100">
          <div class="card-body">
            <h5 class="card-title">
              <a href="{{route('paket.detail', $row->id) }}">{{$row->nama}}</a>
            </h5>
            <p class="card-text">{{$row->deskripsi}}</p>
            <div class="read-more ">
              <a href="{{route('paket.detail', $row->id) }}" class="btn btn-info text-light"><i class="icofont-info-circle">
              </i>Detail</a>
              <a href="{{route('order.index', $row->id) }}" class="btn btn-success text-light"><i class="icofont-arrow-right">
              </i>Pesan Sekarang</a>
            </div>
      ...
      <div class="col-md-6 d-flex align-items-stretch mt-4">
        <div class="card" style='background-image: url("{{asset('icon/tdk.png')}}");' data-aos="fade-up" data-aos-delay="100">
          <div class="card-body">
            ...
            <div class="read-more"><a href="" class="btn btn-success text-light"><i class="icofont-arrow-right"></i>Pesan Sekarang!</a>
            </div>
          </div>
        </div>
      </div>
