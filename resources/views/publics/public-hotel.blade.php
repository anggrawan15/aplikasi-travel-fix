    ...
    <section id="more-services" class="more-services">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-up">
                <h2>Destinasi Hotel</h2>
                <p>Macam-macam hotel yang disediakan</p>
            </div>

        <div class="row">
            @forelse($hotels as $row)
                <div class="col-md-6 d-flex align-items-stretch mt-4">
                    <div class="card" style='background-image: url("{{ asset('storage/hotels/'. $row->gambar) }}");' data-aos="fade-up" data-aos-delay="100">
                    <div class="card-body">
                        <h5 class="card-title"><a href="{{route('hotel.detail', $row->id) }}">{{$row->nama}}</a></h5>
                        <p class="card-text">{{$row->deskripsi}}</p>
                        <div class="read-more"><a href="{{route('hotel.detail', $row->id) }}"><i class="icofont-arrow-right"></i> Lihat Selengkapnya..</a></div>
                    </div>
                </div>
            </div>
            @empty
