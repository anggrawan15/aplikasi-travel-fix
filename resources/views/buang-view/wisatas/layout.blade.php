        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                @if(auth()->guard('customer')->check())
                    <li class="nav-item">
                        <a href="{{route('customer.home')}}" class="nav-link">Home</span></a>
                    </li>
                @else
                    <li class="nav-item">
                        <a href="{{url('/')}}" class="nav-link">Home</span></a>
                    </li>
                @endif
                    <li class="nav-item">
                        <a href="{{ route('wisata.public') }}" class="nav-link active">Wisata <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
