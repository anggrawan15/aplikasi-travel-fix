            ...
            <div id="carouselHome" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('icon/gb1.jpg') }}" alt="" class="img-fluid">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('icon/gb2.jpg') }}" alt="" class="img-fluid">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('icon/gb3.jpg') }}" alt="" class="img-fluid">
                    </div>
                </div>
